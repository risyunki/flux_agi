...
export default function ChatPage() {
  ...
  return (
    <Window className="flex flex-col h-screen overflow-hidden">
      <div className="flex-none border-b dark:border-stone-800 p-4">
      ...
      <div className="flex-none border-t dark:border-stone-800 bg-white/50 dark:bg-stone-950/50 backdrop-blur-sm">
        <form
          onSubmit={(e) => {
            e.preventDefault()
            sendMessage()
          }}
          className="flex space-x-2 p-4 max-w-7xl mx-auto"
        >
          <Input
            value={input}
