    ...
    <div className="max-w-6xl mx-auto p-8 space-y-8">
      ...
      <div className="grid gap-8">
        ...
        <Card className="p-8 backdrop-blur-sm bg-white/50 dark:bg-stone-900/50">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p>
              The Forge system is built on a modern tech stack designed for scalability, reliability, and real-time collaboration:
            </p>
        ...
        <Card className="p-8 backdrop-blur-sm bg-white/50 dark:bg-stone-900/50">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p>
              Forge can be deployed in various environments, from development to production. Here are the recommended deployment methods:
            </p>
...
git clone https://github.com/forgeai/forge
cd forge
...
helm repo add forge https://charts.forgeai.xyz
helm repo update

# Install Forge
helm install forge forge/forge -n forge --create-namespace
...
kubectl get pods -n forge`}
            ...
            <div className="mt-4 p-4 rounded-lg bg-stone-100 dark:bg-stone-800">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <code className="text-sm bg-stone-200 dark:bg-stone-700 px-2 py-1 rounded min-w-[200px]">FORGE_API_KEY</code>
                  <span>Your Forge API key for authentication</span>
                </li>
                <li className="flex items-start gap-2">
        ...
        <Card className="p-8 backdrop-blur-sm bg-white/50 dark:bg-stone-900/50">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p>
              Security is a top priority in Forge. Here are the key security features and best practices:
            </p>
...
curl -X GET https://api.forgeai.xyz/agents \\
...
curl -N -H "Connection: Upgrade" \\
     -H "Upgrade: websocket" \\
     -H "Host: api.forgeai.xyz" \\
     -H "Origin: https://forgeai.xyz" \\
     https://api.forgeai.xyz/ws`}
                    </pre>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-stone-100 dark:bg-stone-800">
                ...
                <ul className="space-y-3 text-sm">
                  <li>
                    ...
                    <pre className="text-sm bg-stone-200 dark:bg-stone-700 p-2 rounded mt-2">
{`# View agent logs
kubectl logs -n forge deployment/agent-pod

# Restart agent
kubectl rollout restart -n forge deployment/agent-pod`}
                    </pre>
                  </li>
                </ul>
              </div>
...
curl https://api.forgeai.xyz/metrics \\
  -H "Authorization: Bearer YOUR_API_KEY"`}
                    </pre>
                  </li>
                </ul>
